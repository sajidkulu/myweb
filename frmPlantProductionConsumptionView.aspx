<%@ page language="C#" autoeventwireup="true" inherits="frmPlantProductionConsumptionView, App_Web_ud0ztfgl" %>
...
<body style="height: 191px; width: 1237px;" bgcolor="#ffffcc">
    ...
    <div style="height:222px; background-color: #808080; width:531px; overflow:auto; position: absolute; left: 792px; top: 797px; bottom: 116px;" >
      <asp:gridview ID="Gridview3" runat="server" ShowFooter="True" 
        ...
        Text="Save" onclick="Button41_Click" Visible="False" />
        ...
        Text="Update" onclick="Button23_Click" Visible="False" />
        ...
        Text="Save" onclick="Button38_Click" Visible="False" />
        ...
        Text="Save" onclick="Button36_Click" Visible="False" />
    ...
    <p>
        ...
        Text="Save" onclick="Button37_Click" Visible="False" />
        </p>
