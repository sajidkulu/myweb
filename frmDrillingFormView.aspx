<%@ page language="C#" autoeventwireup="true" inherits="frmDrillingFormView, App_Web_mjameg3j" %>
...
<body style="height: 191px; width: 1269px;" bgcolor="#666666">
      ...
      <asp:gridview ID="Gridview4" runat="server" ShowFooter="True" 
        ...
        BackColor="Silver">
            ...
            <asp:Button ID="Button28" runat="server" 
                ...
                Text="Save" onclick="Button28_Click" Visible="False" />
    </asp:Panel>
        <asp:Panel 
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 430px; position: absolute;
                top: 60px; right: 323px; width: 80px;" Enabled="False">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 393px; position: absolute; top: 62px; height: 20px; z-index: 1;" 
            ...
            <asp:TextBox ID="TextBox33" runat="server" 
                ...
                style="z-index: 1; left: 771px; position: absolute; width: 61px; top: 99px; height: 26px;" 
    ...
    <p>
        ...
        <asp:Label ID="Label6" runat="server" BackColor="#FFFF99" Font-Bold="True" 
            ...
            Text="Rows" Visible="False"></asp:Label>
        </p>
    ...
    <div style="border: thin solid #008080; height:234px; background-color: #C0C0C0; width:1033px; overflow:auto; position: absolute; left: 246px; top: 253px; bottom: 127px;" >
      ...
      <p>
        ...
        <asp:Button ID="Button36" runat="server" Text="Report" onclick="Button36_Click"
              ...
              style="z-index: 1; top: 213px; position: absolute; height: 30px; width: 73px; left: 1203px; margin-top: 0px; " />
