<%@ page language="C#" autoeventwireup="true" inherits="frmDrillingFormUpdate, App_Web_yttnmsv2" %>
      ...
      <asp:gridview ID="Gridview4" runat="server" ShowFooter="True" 
        ...
        BackColor="Silver">
            ...
            <asp:Button ID="Button28" runat="server" 
                ...
                Text="Update" onclick="Button28_Click" />
                <asp:Button ID="Button32" runat="server" 
                style="z-index: 1; left: 890px; top: 547px; position: absolute; width: 108px; height: 40px; margin-top: 16px;" 
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:TextBox ID="TextBox11" runat="server" Style="left: 81px; position: absolute;
                top: 60px; width: 306px;"></asp:TextBox>
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 430px; position: absolute;
                top: 60px; right: 323px; width: 80px;">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 394px; position: absolute; top: 62px; height: 20px; z-index: 1;" 
            ...
            <asp:Button ID="Button25" runat="server" onclick="Button25_Click" 
                ...
                style="z-index: 1; left: 199px; top: 4px; position: absolute; width: 36px;" 
                Text="+" />
    ...
    <div style="border: thin solid #008080; height:234px; background-color: #C0C0C0; width:1033px; overflow:auto; position: absolute; left: 246px; top: 253px; bottom: 127px;" >
      ...
      <p>
        ...
        <asp:Button ID="Button36" runat="server" Text="Report" onclick="Button36_Click"
              ...
              style="z-index: 1; top: 213px; position: absolute; height: 30px; width: 73px; left: 1205px; margin-top: 0px; " />
