<%@ page language="C#" autoeventwireup="true" inherits="frmSurveyReportView, App_Web_sajjfdyo" %>
...
<body style="height: 191px; width: 1237px;" bgcolor="#669999">
    <form id="form1" runat="server">
      ...
      <asp:gridview ID="Gridview4" runat="server" ShowFooter="True" 
        ...
        <asp:Button ID="Button13" runat="server" BackColor="Gray" BorderStyle="Solid" 
            Style="cursor: hand; left: 206px; position: absolute; top: 212px; z-index: 109; width: 168px; height: 32px; " 
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="Gray" Height="90px" Style="display: inline;
            ...
            <asp:TextBox ID="TextBox11" runat="server" Style="left: 81px; position: absolute;
                top: 60px; width: 290px; height: 24px;" Enabled="False"></asp:TextBox>
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 431px; position: absolute;
                top: 60px; right: 476px; width: 80px;" Enabled="False">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 379px; position: absolute; top: 61px; height: 20px; z-index: 1;" 
    ...
    <div style="height:235px; background-color: #808080; width:1130px; overflow:auto; position: absolute; left: 207px; top: 250px; bottom: 137px;" >
