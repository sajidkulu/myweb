<%@ page language="C#" autoeventwireup="true" inherits="frmWorkShopEntry, App_Web_ud0ztfgl" %>
    ...
    <form id="form1" runat="server">
      ...
      <asp:gridview ID="Gridview4" runat="server" ShowFooter="True" 
        ...
        <asp:AccessDataSource ID="AccessDataSource2" runat="server" 
          ...
          SelectCommand="SELECT [GDMainID], [Equip_Code], [DETAIL_OF_ACTIVITY], [FASULTANDBREAKDOWNS], [Remarks] FROM [Tbl_M_Product_WorkShop]">
      </asp:AccessDataSource>
      <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
          DataFile="~/Forms/MyDBase.mdb" 
          SelectCommand="SELECT [GDMainID], [Equip_Code], [DETAIL_OF_ACTIVITY], [FASULT AND BREAKDOWNS] AS FASULT_AND_BREAKDOWNS, [Remarks] FROM [Tbl_M_Product_WorkShop]">
      </asp:AccessDataSource>
...
&nbsp;<asp:Label ID="Label3" runat="server" Style="left: 15px; position: absolute; top: 61px; right: 1121px;"
            ...
            <asp:TextBox ID="TextBox11" runat="server" Style="left: 81px; position: absolute;
                top: 60px; width: 298px; height: 22px;"></asp:TextBox>
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 430px; position: absolute;
                top: 60px; right: 316px; width: 80px;">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 387px; position: absolute; top: 60px; height: 20px; z-index: 1;" 
            ...
            <asp:Button ID="Button25" runat="server" onclick="Button25_Click" 
                ...
                style="z-index: 1; left: 195px; top: 3px; position: absolute; width: 36px;" 
                Text="+" />
        </asp:Panel>
    <p>
        &nbsp;</p>
    ...
    <div style="height:210px; background-color: #808080; width:1018px; overflow:auto; position: absolute; left: 249px; top: 255px; bottom: 43px;" >
      ...
      <asp:gridview ID="Gridview1" runat="server" ShowFooter="True" 
            AutoGenerateColumns="False" 
            style="z-index: 1; left: 7px; top: 8px; position: absolute; height: 95px; width: 939px" 
            BackColor="#CCCCCC" ForeColor="Black" Font-Size="Smaller" 
            >
            <Columns>
                <%--=======================================================================--%>
            ...
            <asp:TemplateField HeaderText="ACTIVITIES">
             ...
             <%--=======================================================================--%>
            <asp:TemplateField HeaderText="FAULTS AND BREAKDOWNS">
                <ItemTemplate>
                     <asp:TextBox ID="TextBox3" runat="server"></asp:TextBox>
                </ItemTemplate>
            </asp:TemplateField>
