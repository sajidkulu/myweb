<%@ page language="C#" autoeventwireup="true" inherits="frmAshlantPlantUpdate, App_Web_sajjfdyo" %>
      ...
      <p>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:Label ID="Label5" runat="server" 
                Style="left: 404px; position: absolute; top: 60px; height: 20px; z-index: 1;" 
            ...
            <asp:DropDownList ID="DropDownList2" runat="server" AppendDataBoundItems="True" 
                ...
                style="z-index: 1; left: 80px; top: 33px; position: absolute; right: 419px; height: 10px; width: 434px;">
            </asp:DropDownList>
