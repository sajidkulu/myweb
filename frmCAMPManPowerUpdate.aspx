<%@ page language="C#" autoeventwireup="true" inherits="frmCAMPManPowerUpdate, App_Web_ud0ztfgl" %>
      ...
      <p>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 434px; position: absolute;
                top: 61px; right: 427px; width: 80px;">
            ...
            <asp:DropDownList ID="DropDownList2" runat="server" AppendDataBoundItems="True" 
                ...
                style="z-index: 1; left: 84px; top: 33px; position: absolute; right: 427px" 
                Width="430px">
            </asp:DropDownList>
