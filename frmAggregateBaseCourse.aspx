<%@ page language="C#" autoeventwireup="true" inherits="frmAggregateBaseCourse, App_Web_sajjfdyo" %>
...
<body style="height: 191px; width: 1237px;" bgcolor="#ffffcc">
      ...
      <asp:gridview ID="Gridview4" runat="server" ShowFooter="True" 
        ...
        <asp:Button ID="Button13" runat="server" BackColor="Gray" BorderStyle="Solid" 
          ...
          runat="server" Text="Clear" onclick="Button29_Click" 
                style="z-index: 1; top: 215px; position: absolute; height: 33px; width: 100px; left: 874px; margin-top: 0px; right: 116px;" 
                Width="125px" />
      <asp:Panel ID="Panel5" runat="server" BorderStyle="Solid"
        ...
        BackColor="#999966">
            <asp:Button ID="Button26" runat="server" Text="Home" 
                ...
                <asp:Button ID="Button2" runat="server" Text="Entry Status" 
                style="z-index: 1; left: 13px; top: 50px; position: absolute" 
                Width="103px" onclick="Button2_Click"/>

            <div style="height:182px; background-color: #808080; width:177px; overflow:auto; position: absolute; left: 4px; top: 91px; bottom: 592px;">
                <asp:GridView ID="Gridview7" runat="server" AutoGenerateColumns="False" 
                    BackColor="#CCCCCC" Enabled="False" Font-Size="Smaller" ForeColor="Black" 
                    ShowFooter="True" 
                    style="z-index: 1; left: 7px; top: 8px; position: absolute; height: 95px; width: 161px">
                    <Columns>
                        <%--=======================================================================--%>
        ...
        Font-Size="Larger">
            <span style="font-size: 28pt; font-family: Tahoma">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                ID="Calendar1" runat="server" BackColor="White" BorderColor="Black"  OnClientClick="return false;" 
                BorderStyle="Solid" CellSpacing="1" EnableTheming="True" Font-Names="Verdana" 
                Font-Size="9pt" ForeColor="Black" NextPrevFormat="ShortMonth" 
                onselectionchanged="Calendar1_SelectionChanged" 
                SelectedDate="03/01/2017 10:19:38" Style="left: 240px;
            position: absolute; top: -25px; width: 69px; height: 143px;" 
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:Label ID="Label1" runat="server" 
                Style="left: 15px; position: absolute; top: 34px" Text="Company"></asp:Label>
            &nbsp;&nbsp;
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 435px; position: absolute;
                top: 59px; right: 311px; width: 80px;">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 403px; position: absolute; top: 62px; height: 20px; z-index: 1;" 
            ...
            <asp:DropDownList ID="DropDownList2" runat="server" AppendDataBoundItems="True" 
                ...
                style="z-index: 1; left: 80px; top: 33px; position: absolute; right: 302px; width: 436px;">
            </asp:DropDownList>
            <asp:TextBox ID="TextBox33" runat="server" 
                style="z-index: 1; left: 732px; position: absolute; width: 84px; top: 60px"></asp:TextBox>
            ...
            <asp:Button ID="Button25" runat="server" onclick="Button25_Click"
                style="z-index: 1; left: 199px; top: 2px; position: absolute; width: 36px;" 
                Text="+" />
            <asp:TextBox ID="TextBox35" runat="server" 
                style="z-index: 1; left: 529px; position: absolute; width: 291px; top: 31px"></asp:TextBox>
        </asp:Panel>
    <p>
    ...
    <div style="height:224px; background-color: #808080; width:909px; overflow:auto; position: absolute; left: 249px; top: 519px; bottom: 107px;" >
      <asp:gridview ID="Gridview2" runat="server" ShowFooter="True" 
            AutoGenerateColumns="False"
            style="z-index: 1; left: 7px; top: 13px; position: absolute; height: 95px; width: 621px" 
    ...
    <div style="height:224px; background-color: #808080; width:563px; overflow:auto; position: absolute; left: 250px; top: 799px; bottom: 6px;" >
      <asp:gridview ID="Gridview3" runat="server" ShowFooter="True" 
        ...
        <asp:TextBox ID="TextBox31" runat="server" Style="left: 435px; position: absolute;
            top: 216px; z-index: 110; height: 31px;" TextMode="MultiLine" Width="425px" 
            BackColor="#C0C0FF"></asp:TextBox>
        </p>
    <p>
        ...
        <asp:Button ID="Button4" runat="server" Text="ABC Report" onclick="Button4_Click" 
                
          
          
          style="z-index: 1; top: 216px; position: absolute; height: 30px; width: 95px; left: 1171px; margin-top: 0px; right: 8px;" 
          Visible="False" />
    <asp:Button ID="Button15" runat="server" onclick="Button15_Click" 
        style="z-index: 1; left: 249px; top: 1035px; position: absolute; width: 101px; height: 41px; right: 574px;" 
        Text="Save" />
    <asp:Button ID="Button16" runat="server" onclick="Button16_Click" 
        ...
        Text="Convert Date" onclick="Button23_Click" Visible="False" />
