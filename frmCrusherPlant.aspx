<%@ page language="C#" autoeventwireup="true" inherits="frmCrusherPlant, App_Web_hpap54ws" %>
...
&nbsp;
            ...
            <asp:TextBox ID="TextBox11" runat="server" Style="left: 81px; position: absolute;
                top: 60px; width: 304px; height: 23px;"></asp:TextBox>
            ...
            <asp:Label ID="Label5" runat="server" 
                Style="left: 391px; position: absolute; top: 61px; height: 20px; z-index: 1;" 
