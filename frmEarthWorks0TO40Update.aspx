<%@ page language="C#" autoeventwireup="true" inherits="frmEarthWorks0TO40Update, App_Web_hpap54ws" %>
      ...
      <p>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:Label ID="Label5" runat="server" 
                Style="left: 386px; position: absolute; top: 60px; height: 20px; z-index: 1;" 
