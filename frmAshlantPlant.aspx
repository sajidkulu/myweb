<%@ page language="C#" autoeventwireup="true" inherits="frmAshlantPlant, App_Web_ud0ztfgl" %>
    ...
    <form id="form1" runat="server">
      ...
      <p>
        ...
        <asp:Button ID="Button30" runat="server" BackColor="Gray" BorderStyle="Solid" 
            Style="cursor: hand; left: 215px; position: absolute; top: 476px; z-index: 109; width: 175px; height: 32px; " 
        ...
        style="z-index: 1; left: 10px; top: 210px; position: absolute; height: 1118px; width: 190px" 
        BackColor="#999966">
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 435px; position: absolute;
                top: 58px; right: 426px; width: 80px;">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 403px; position: absolute; top: 61px; height: 20px; z-index: 1;" 
            ...
            <asp:Button ID="Button35" runat="server" onclick="Button35_Click" 
                style="z-index: 1; left: 822px; top: 57px; position: absolute; width: 109px" 
                Text="Update Form" />
        </asp:Panel>
    <p>
        &nbsp;</p>
    ...
    <div style="height:212px; background-color: #808080; width:563px; overflow:auto; position: absolute; left: 220px; top: 1070px; bottom: 174px;" >
      <asp:gridview ID="Gridview3" runat="server" ShowFooter="True" 
        ...
        <asp:TextBox ID="TextBox30" runat="server" Style="left: 399px; position: absolute;
            ...
            BackColor="#C0C0FF"></asp:TextBox>
        <asp:Button ID="Button36" runat="server" Text="Production And Consumption" onclick="Button36_Click" 
                
                style="z-index: 1; top: 214px; position: absolute; height: 33px; width: 186px; left: 934px; margin-top: 0px; right: 211px;" />
        </p>
    <p>
