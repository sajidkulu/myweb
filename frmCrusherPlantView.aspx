<%@ page language="C#" autoeventwireup="true" inherits="frmCrusherPlantView, App_Web_sajjfdyo" %>
...
<body style="height: 191px; width: 1237px;" bgcolor="#ffffcc">
    ...
    <div style="height:214px; background-color: #808080; width:664px; overflow:auto; position: absolute; left: 220px; top: 1045px; bottom: 53px;" >
      ...
      <p>
        ...
        <asp:Button ID="Button33" runat="server" BackColor="Gray" BorderStyle="Solid" 
            ...
            Text="Material Transfer Data" onclick="Button33_Click" Enabled="False" 
              ForeColor="White"/>
      ...
      <asp:gridview ID="Gridview12" runat="server" ShowFooter="True" 
        ...
        <asp:Button ID="Button31" runat="server" BackColor="Gray" BorderStyle="Solid" 
            ...
            Text="Premix Data" onclick="Button31_Click" Enabled="False" 
              ForeColor="White"/>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:TextBox ID="TextBox11" runat="server" Style="left: 81px; position: absolute;
                top: 60px; width: 307px; height: 22px;"></asp:TextBox>
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 432px; position: absolute;
                top: 60px; right: 429px; width: 80px;" Enabled="False">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 394px; position: absolute; top: 60px; height: 20px; z-index: 1;" 
    ...
    <div style="height:210px; background-color: #808080; width:1125px; overflow:auto; position: absolute; left: 214px; top: 256px; bottom: 99px;" >
      ...
      <asp:gridview ID="Gridview1" runat="server" ShowFooter="True" 
            AutoGenerateColumns="False" 
            style="z-index: 1; left: 7px; top: 8px; position: absolute; height: 95px; width: 1054px" 
            BackColor="#CCCCCC" ForeColor="Black" Font-Size="Smaller" Enabled="False" 
            >
            <Columns>
            <%--=======================================================================--%>
      ...
      <asp:gridview ID="Gridview7" runat="server" ShowFooter="True" 
            AutoGenerateColumns="False" 
            style="z-index: 1; left: 18px; top: 1861px; position: absolute; height: 95px; width: 671px; right: -4px; bottom: 224px;" 
            BackColor="#666699" ForeColor="#9999FF" Visible="False">
            <Columns>
                <asp:BoundField DataField="GDMainID" HeaderText="GDMainID" 
                    SortExpression="GDMainID" />
        ...
        <asp:AccessDataSource ID="AccessDataSource2" runat="server" 
          ...
          SelectCommand="SELECT [GDMainID], [Agg05], [Agg510], [Agg1020], [Agg2025], [Agg2037], [Agg010], [Agg020], [Agg2050], [BYPASS], [SubGrade], [QtyDAY], [QtyNIGHT], [UnitID] FROM [Tbl_M_Produc_Crusher_Plant]">
      </asp:AccessDataSource>
      <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
          DataFile="~/Forms/MyDBase.mdb" 
          SelectCommand="SELECT [Agg05], [Agg510], [Agg1020], [Agg2025], [Agg2037], [Agg010], [Agg020], [Agg2050], [BYPASS], [SubGrade], [QtyDAY], [QtyNIGHT], [UnitID] FROM [Tbl_M_Produc_Crusher_Plant]">
      </asp:AccessDataSource>
        <p>
    ...
    <div style="height:214px; background-color: #808080; width:1093px; overflow:auto; position: absolute; left: 217px; top: 518px; bottom: 61px;" >
      ...
      <asp:gridview ID="Gridview4" runat="server" ShowFooter="True" 
            AutoGenerateColumns="False" 
            style="z-index: 1; left: 18px; top: 2030px; position: absolute; height: 95px; width: 671px; right: 79px; bottom: 55px;" 
            BackColor="#666699" ForeColor="#9999FF" Visible="False">
            <Columns>
                <asp:BoundField DataField="GDMainID" HeaderText="GDMainID" 
                    SortExpression="GDMainID" />
