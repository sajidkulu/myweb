<%@ page language="C#" autoeventwireup="true" inherits="frmCAMPManPower, App_Web_mjameg3j" %>
    ...
    <form id="form1" runat="server">
      ...
      <p>
        ...
        Font-Size="Larger">
            ...
            position: absolute; top: -2px; width: 69px; height: 0px;" 
...
&nbsp;<asp:Label ID="Label3" runat="server" Style="left: 15px; position: absolute; top: 61px; right: 1121px;"
            ...
            <asp:TextBox ID="TextBox11" runat="server" Style="left: 81px; position: absolute;
                top: 60px; width: 304px;"></asp:TextBox>
            ...
            <asp:Label ID="Label5" runat="server" 
                Style="left: 392px; position: absolute; top: 60px; height: 20px; z-index: 1;" 
    ...
    <p>
        ...
        <asp:Button ID="Button11" runat="server" BackColor="Gray" BorderStyle="Solid" 
            ...
            Text="Paste CAMP Manpower Data" onclick="Button11_Click"/>
        </p>
        <p>
        <asp:Button ID="Button23" runat="server" 
        style="z-index: 1; left: 173px; top: 481px; position: absolute; width: 108px; height: 40px; margin-top: 16px;" 
