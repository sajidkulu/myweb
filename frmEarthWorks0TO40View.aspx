<%@ page language="C#" autoeventwireup="true" inherits="frmEarthWorks0TO40View, App_Web_ud0ztfgl" %>
    ...
    <div style="height:214px; background-color: #808080; width:891px; overflow:auto; position: absolute; left: 220px; top: 783px; bottom: 125px;" >
      ...
      <p>
        ...
        <asp:Button ID="Button33" runat="server" BackColor="Gray" BorderStyle="Solid" 
            ...
            Text="Heavy Equipment Data" onclick="Button33_Click" Enabled="False" 
              ForeColor="White"/>
        ...
        <asp:Button ID="Button30" runat="server" BackColor="Gray" BorderStyle="Solid" 
            ...
            Text="Dumper Equipment Data" onclick="Button30_Click" Enabled="False" 
              ForeColor="White"/>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:TextBox ID="TextBox11" runat="server" Style="left: 81px; position: absolute;
                top: 60px; width: 299px;" Enabled="False"></asp:TextBox>
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 431px; position: absolute;
                top: 59px; right: 430px; width: 80px;" Enabled="False">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 387px; position: absolute; top: 61px; height: 20px; z-index: 1;" 
