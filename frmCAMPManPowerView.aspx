<%@ page language="C#" autoeventwireup="true" inherits="frmCAMPManPowerView, App_Web_sajjfdyo" %>
...
<body style="height: 191px; width: 1237px;" bgcolor="#ffffcc">
    <form id="form1" runat="server">
      ...
      <p>
        ...
        style="z-index: 1; left: 14px; top: 210px; position: absolute; height: 318px; width: 141px" 
        BackColor="#999966">
        ...
        Font-Size="Larger">
            <span style="font-size: 28pt; font-family: Tahoma">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                SelectedDate="03/01/2017 10:19:38" Style="left: 310px;
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:TextBox ID="TextBox11" runat="server" Style="left: 81px; position: absolute;
                top: 60px; width: 304px;" Enabled="False"></asp:TextBox>
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 430px; position: absolute;
                top: 59px; right: 431px; width: 80px;" Enabled="False">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 391px; position: absolute; top: 62px; height: 20px; z-index: 1;" 
            ...
            <asp:Button ID="Button25" runat="server" onclick="Button25_Click" 
                ...
                Text="+" />
            <asp:Label ID="Label8" runat="server" BackColor="WhiteSmoke" BorderStyle="None" 
                Enabled="False" Font-Bold="True" Font-Size="Large" ForeColor="#CC3300" 
                Style="display: inline; left: 529px; position: absolute; top: 62px; width: 286px; height: 20px; text-align: left;"></asp:Label>
        </asp:Panel>
    <p>
        &nbsp;</p>
        ...
        Width="186px" />
    <div style="height:224px; background-color: #808080; width:909px; overflow:auto; position: absolute; left: 172px; top: 259px; bottom: 196px;" >
      <asp:gridview ID="Gridview2" runat="server" ShowFooter="True" 
            AutoGenerateColumns="False"
            style="z-index: 1; left: 7px; top: 12px; position: absolute; height: 95px; width: 848px" 
        ...
        <p>
        <asp:TextBox ID="TextBox30" runat="server" Style="left: 378px; position: absolute;
            top: 211px; z-index: 110; height: 36px;" TextMode="MultiLine" Width="425px" 
    ...
    <p>
        ...
        <asp:Button ID="Button11" runat="server" BackColor="Gray" BorderStyle="Solid" 
            Style="left: 169px;
            cursor: hand; position: absolute; top: 212px; z-index: 109; width: 195px; height: 37px; right: 537px;" 
            Text="CAMP Manpower Data" onclick="Button11_Click" Enabled="False" 
            ForeColor="White"/>
        </p>
        <p>
        <asp:Button ID="Button23" runat="server" 
        style="z-index: 1; left: 173px; top: 481px; position: absolute; width: 108px; height: 40px; margin-top: 16px; right: 919px;" 
      ...
      <p>
        ...
        style="z-index: 1; left: 971px; top: 478px; position: absolute; width: 108px; height: 40px; margin-top: 16px;" 
      ...
      <asp:gridview ID="Gridview5" runat="server" ShowFooter="True" 
            AutoGenerateColumns="False" 
            style="z-index: 1; left: 15px; top: 550px; position: absolute; height: 95px; width: 494px; right: 207px;" 
