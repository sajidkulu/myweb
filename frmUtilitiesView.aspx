<%@ page language="C#" autoeventwireup="true" inherits="frmUtilitiesView, App_Web_yttnmsv2" %>
    ...
    <form id="form1" runat="server">
      ...
      <asp:gridview ID="Gridview4" runat="server" ShowFooter="True" 
        ...
        Font-Size="Larger">
            ...
            position: absolute; top: -8px; width: 69px; height: 0px;" 
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:TextBox ID="TextBox11" runat="server" Style="left: 81px; position: absolute;
                top: 60px; width: 295px;" Enabled="False"></asp:TextBox>
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 430px; position: absolute;
                top: 60px; right: 316px; width: 80px;" Enabled="False">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 385px; position: absolute; top: 62px; height: 20px; z-index: 1;" 
            ...
            <asp:Button ID="Button25" runat="server" onclick="Button25_Click" 
                ...
                style="z-index: 1; left: 198px; top: 2px; position: absolute; width: 36px;" 
                Text="+" />
        </asp:Panel>
    <p>
        &nbsp;</p>
    ...
    <div style="height:224px; background-color: #808080; width:563px; overflow:auto; position: absolute; left: 250px; top: 799px; bottom: 6px;" >
      <asp:gridview ID="Gridview3" runat="server" ShowFooter="True" 
        ...
        <asp:TextBox ID="TextBox30" runat="server" Style="left: 426px; position: absolute;
            top: 474px; z-index: 110; height: 33px; bottom: 457px;" TextMode="MultiLine" Width="425px" 
