<%@ page language="C#" autoeventwireup="true" inherits="frmPlantProductionConsumptionUpdate, App_Web_hpap54ws" %>
...
<body style="height: 191px; width: 1237px;" bgcolor="#ffffcc">
      ...
      <p>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            &nbsp;<asp:Button ID="Button35" runat="server" onclick="Button35_Click" 
                ...
                Text="Update Form" Visible="False" />
    ...
    <div style="height:222px; background-color: #808080; width:531px; overflow:auto; position: absolute; left: 792px; top: 797px; bottom: 116px;" >
      <asp:gridview ID="Gridview3" runat="server" ShowFooter="True" 
        ...
        style="z-index: 1; left: 1261px; top: 733px; position: absolute; width: 62px; height: 31px; margin-top: 16px;" 
        Text="Update" onclick="Button39_Click" />
        ...
        style="z-index: 1; left: 1120px; top: 457px; position: absolute; width: 114px; height: 29px; margin-top: 16px;" 
        ...
        Text="Update" onclick="Button42_Click" />
        ...
        Text="Update" onclick="Button44_Click" />
        </p>
    <p>
        ...
        Text="Update" onclick="Button40_Click" />
        ...
        style="z-index: 1; left: 1165px; top: 733px; position: absolute; width: 83px; height: 32px; margin-top: 16px;" 
    ...
    <div style="height:214px; background-color: #808080; width:762px; overflow:auto; position: absolute; left: 13px; top: 514px; bottom: 179px;" >
      ...
      <p>
        ...
        style="z-index: 1; left: 1250px; top: 457px; position: absolute; width: 80px; height: 29px; margin-top: 16px;" 
        Text="Update" onclick="Button43_Click" />
        </p>
