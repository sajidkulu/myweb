<%@ page language="C#" autoeventwireup="true" inherits="frmSteelYardUpdate, App_Web_yttnmsv2" %>
...
<body style="height: 191px; width: 1237px;" bgcolor="#ffffcc">
    ...
    <div style="height:214px; background-color: #808080; width:1102px; overflow:auto; position: absolute; left: 220px; top: 1045px; bottom: 104px;" >
      ...
      <p>
        ...
        Text="Summary Report" onclick="Button32_Click" />
      ...
      <asp:gridview ID="Gridview12" runat="server" ShowFooter="True" 
        ...
        <asp:Button ID="Button30" runat="server" BackColor="Gray" BorderStyle="Solid" 
            ...
            Text="Paste Steel Consumption Data" onclick="Button30_Click"/>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:TextBox ID="TextBox11" runat="server" Style="left: 81px; position: absolute;
                top: 60px; width: 291px;"></asp:TextBox>
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 429px; position: absolute;
                top: 60px; right: 432px; width: 80px;">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 383px; position: absolute; top: 61px; height: 20px; z-index: 1;" 
    ...
    <div style="height:210px; background-color: #808080; width:1125px; overflow:auto; position: absolute; left: 214px; top: 256px; bottom: 99px;" >
      ...
      <asp:gridview ID="Gridview1" runat="server" ShowFooter="True" 
            AutoGenerateColumns="False" 
            style="z-index: 1; left: 7px; top: 8px; position: absolute; height: 95px; width: 685px" 
            BackColor="#CCCCCC" ForeColor="Black" Font-Size="Smaller" 
            >
            <Columns>
            <%--=======================================================================--%>
