<%@ page language="C#" autoeventwireup="true" inherits="frmUtilities, App_Web_sajjfdyo" %>
...
&nbsp;
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 430px; position: absolute;
                top: 58px; right: 316px; width: 80px;">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 386px; position: absolute; top: 61px; height: 20px; z-index: 1;" 
