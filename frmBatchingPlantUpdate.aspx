<%@ page language="C#" autoeventwireup="true" inherits="frmBatchingPlantUpdate, App_Web_sajjfdyo" %>
      ...
      <asp:gridview ID="Gridview4" runat="server" ShowFooter="True" 
        ...
        Font-Size="Larger">
            <span style="font-size: 28pt; font-family: Tahoma">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                SelectedDate="03/01/2017 10:19:38" Style="left: 313px;
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="Gray" Height="90px" Style="display: inline;
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 434px; position: absolute;
                top: 58px; right: 312px; width: 80px;">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 402px; position: absolute; top: 61px; height: 20px; z-index: 1;" 
            ...
            <asp:DropDownList ID="DropDownList2" runat="server" AppendDataBoundItems="True" 
                ...
                style="z-index: 1; left: 80px; top: 33px; position: absolute; right: 304px; width: 434px;">
            </asp:DropDownList>
