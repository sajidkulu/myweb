<%@ page language="C#" autoeventwireup="true" inherits="frmCAMPFormUpdate, App_Web_yttnmsv2" %>
      ...
      <p>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 431px; position: absolute;
                top: 58px; right: 430px; width: 80px;">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 390px; position: absolute; top: 61px; height: 20px; z-index: 1;" 
    ...
    <div style="height:212px; background-color: #808080; width:570px; overflow:auto; position: absolute; left: 173px; top: 1076px; bottom: 189px;" >
      <asp:gridview ID="Gridview3" runat="server" ShowFooter="True" 
        ...
        <asp:Button ID="Button36" runat="server" Text="Report" onclick="Button36_Click"
                ...
                style="z-index: 1; top: 213px; position: absolute; height: 30px; width: 73px; left: 1109px; margin-top: 0px; " />
