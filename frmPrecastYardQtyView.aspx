<%@ page language="C#" autoeventwireup="true" inherits="frmPrecastYardQtyView, App_Web_hpap54ws" %>
...
<body style="height: 191px; width: 1237px;" bgcolor="#ffffcc">
    <form id="form1" runat="server">
      ...
      <asp:gridview ID="Gridview4" runat="server" ShowFooter="True" 
        ...
        <asp:Button ID="Button13" runat="server" BackColor="Gray" BorderStyle="Solid" 
            ...
            Text="Precast Yard Data" onclick="Button13_Click" Enabled="False" 
          ForeColor="White"/>
        <p>
        <asp:Button ID="Button29" runat="server" BackColor="Gray" BorderStyle="Solid" 
            ...
            Text="Precast Yard Qty Data" onclick="Button29_Click" Enabled="False" 
                ForeColor="White"/>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 431px; position: absolute;
                top: 60px; right: 430px; width: 80px;" Enabled="False">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 388px; position: absolute; top: 62px; height: 20px; z-index: 1;" 
    ...
    <p>
        <asp:TextBox ID="TextBox32" runat="server" Style="left: 374px; position: absolute;
            ...
            BackColor="#C0C0FF" Enabled="False" Visible="False"></asp:TextBox>
    ...
    <asp:Button ID="Button15" runat="server" onclick="Button15_Click" 
        style="z-index: 1; left: 222px; top: 1297px; position: absolute; width: 101px; height: 41px; right: 462px;" 
    ...
    <asp:Button ID="Button16" runat="server" onclick="Button16_Click" 
        ...
        Text="Equipment Data" BackColor="Gray" BorderStyle="Solid" Enabled="False" 
          ForeColor="White" />
    <div style="height:210px; background-color: #808080; width:1028px; overflow:auto; position: absolute; left: 214px; top: 256px; bottom: 42px;" >
        
      <asp:gridview ID="Gridview1" runat="server" ShowFooter="True" 
            AutoGenerateColumns="False" 
            style="z-index: 1; left: 7px; top: 8px; position: absolute; height: 95px; width: 936px" 
            BackColor="#CCCCCC" ForeColor="Black" Font-Size="Smaller" Enabled="False" 
            >
            <Columns>
