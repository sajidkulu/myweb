<%@ page language="C#" autoeventwireup="true" inherits="frmConstructionActUpdate, App_Web_hpap54ws" %>
...
<body style="height: 191px; width: 1237px;" bgcolor="#7d7d7d">
    <form id="form1" runat="server">
      ...
      <asp:gridview ID="Gridview4" runat="server" ShowFooter="True" 
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#999966" Height="90px" Style="display: inline;
            ...
            <asp:Label ID="Label1" runat="server" Style="left: 616px; position: absolute; top: 62px"
                Text="User Name" BorderStyle="None"></asp:Label>
            &nbsp;&nbsp;
            ...
            <asp:TextBox ID="TextBox34" runat="server" Style="left: 696px; position: absolute;
                top: 61px; width: 112px; height: 18px;" Enabled="False" Font-Bold="True" 
    ...
    <asp:Button ID="Button16" runat="server" onclick="Button16_Click" 
        ...
        Text="Summary Report" />
    <div style="border: thin solid #008080; height:210px; background-color: #C0C0C0; width:1021px; overflow:auto; position: absolute; left: 253px; top: 253px; bottom: 155px;" >
