<%@ page language="C#" autoeventwireup="true" inherits="frmBatchingPlant, App_Web_mjameg3j" %>
      ...
      <asp:gridview ID="Gridview4" runat="server" ShowFooter="True" 
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="Gray" Height="90px" Style="display: inline;
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 432px; position: absolute;
                top: 60px; right: 314px; width: 80px;">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 401px; position: absolute; top: 62px; height: 20px; z-index: 1;" 
