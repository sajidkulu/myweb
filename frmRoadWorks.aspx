<%@ page language="C#" autoeventwireup="true" inherits="frmRoadWorks, App_Web_sajjfdyo" %>
    ...
    <form id="form1" runat="server">
      ...
      <asp:gridview ID="Gridview4" runat="server" ShowFooter="True" 
          ...
          <Columns>
              ...
              <asp:BoundField DataField="QtyMT" HeaderText="QtyMT" SortExpression="QtyMT" />
        ...
        BackColor="#999966">
            <asp:Button ID="Button26" runat="server" Text="Home" 
                style="z-index: 1; left: 16px; top: 33px; position: absolute" 
            ...
            <cc1:DatePicker ID="DatePicker1" runat="server" 
                style="z-index: 1; left: 5px; top: 10px; position: absolute" 
                Visible="False" />
    </asp:Panel>
        <asp:Panel 
        ...
        Font-Size="Larger">
            <span style="font-size: 28pt; font-family: Tahoma">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                ...
                SelectedDate="2017-05-21" Style="left: 243px;
            position: absolute; top: -7px; width: 69px; height: 0px;" 
                VisibleDate="2017-05-21" CellPadding="0">
...
&nbsp;
            ...
            <asp:TextBox ID="TextBox11" runat="server" Style="left: 81px; position: absolute;
                top: 60px; width: 293px;"></asp:TextBox>
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 429px; position: absolute;
                top: 59px; right: 317px; width: 80px;">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 385px; position: absolute; top: 60px; height: 20px; z-index: 1;" 
    ...
    <asp:Button ID="Button15" runat="server" onclick="Button15_Click" 
        style="z-index: 1; left: 249px; top: 1035px; position: absolute; width: 101px; height: 46px; bottom: 225px;" 
        Text="Save" />
    ...
    <div style="height:210px; background-color: #808080; width:1018px; overflow:auto; position: absolute; left: 249px; top: 255px; bottom: 43px;" >
      ...
      <asp:gridview ID="Gridview1" runat="server" ShowFooter="True" 
            AutoGenerateColumns="False" 
            style="z-index: 1; left: 7px; top: 8px; position: absolute; height: 95px; width: 743px" 
            BackColor="#CCCCCC" ForeColor="Black" Font-Size="Smaller" 
            >
            <Columns>
                <%--=======================================================================--%>
             ...
             <%--=======================================================================--%>
                ...
                <%--=======================================================================--%>
                 ...
                 <%--=======================================================================--%>
                <%--=======================================================================--%>
            <asp:TemplateField HeaderText="Activity_Description" ItemStyle-Width ="100px">
                <ItemTemplate>
                    <asp:TextBox ID="TextBox1" runat="server"></asp:TextBox>
                </ItemTemplate>
            ...
            <ItemStyle Width="100px"></ItemStyle>
             ...
             <%--=======================================================================--%>
                <asp:TemplateField HeaderText="QTY(M2)">
                <ItemTemplate>
                     <asp:TextBox ID="TextBox2" runat="server"></asp:TextBox>
                </ItemTemplate>
                ...
                <%--=======================================================================--%>
            <asp:TemplateField HeaderText="QTY(MT)">
                <ItemTemplate>
                     <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
                </ItemTemplate>
                <ControlStyle Width="60px" />
                ...
                <asp:TemplateField HeaderText="REMARKS">
                    ...
                    <FooterTemplate>
                        <asp:Button ID="ButtonAddNewRow4" runat="server" 
                            onclick="ButtonAdd_ClickNewGridView1" Text="Add Row" />
                    </FooterTemplate>
