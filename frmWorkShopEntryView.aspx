<%@ page language="C#" autoeventwireup="true" inherits="frmWorkShopEntryView, App_Web_yttnmsv2" %>
      ...
      <asp:AccessDataSource ID="AccessDataSource1" runat="server" 
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:TextBox ID="TextBox11" runat="server" Style="left: 81px; position: absolute;
                top: 60px; width: 303px; height: 25px;" Enabled="False"></asp:TextBox>
            ...
            <asp:Label ID="Label5" runat="server" 
                Style="left: 390px; position: absolute; top: 64px; height: 20px; z-index: 1;" 
