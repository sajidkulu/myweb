<%@ page language="C#" autoeventwireup="true" inherits="frmCAMPFormView, App_Web_ud0ztfgl" %>
...
<body style="height: 191px; width: 1237px;" bgcolor="#ffffcc">
    ...
    <div style="height:214px; background-color: #808080; width:654px; overflow:auto; position: absolute; left: 685px; top: 520px; bottom: 173px;" >
      ...
      <p>
        ...
        <asp:Button ID="Button33" runat="server" BackColor="Gray" BorderStyle="Solid" 
            ...
            Text="Accumodation +Food Data" onclick="Button33_Click" Enabled="False" 
              ForeColor="White"/>
        ...
        <asp:Button ID="Button30" runat="server" BackColor="Gray" BorderStyle="Solid" 
            Style="cursor: hand; left: 171px; position: absolute; top: 476px; z-index: 109; width: 132px; height: 32px; bottom: 342px; right: 559px;" 
            Text="Worker Data" onclick="Button30_Click" Enabled="False" 
              ForeColor="White"/>
        <asp:TextBox ID="TextBox46" runat="server" Style="left: 311px; position: absolute;
            top: 475px; z-index: 110; height: 31px; width: 357px; right: 371px;" TextMode="MultiLine" 
        ...
        <asp:Button ID="Button29" runat="server" BackColor="Gray" BorderStyle="Solid" 
            ...
            Text="Paste SteelYard Data" onclick="Button29_Click" Enabled="False" 
              ForeColor="White"/>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="#408080" Height="90px" Style="display: inline;
            ...
            <asp:DropDownList ID="DropDownList1" runat="server" Style="left: 433px; position: absolute;
                top: 60px; right: 428px; width: 80px;" Enabled="False">
                <asp:ListItem>Day</asp:ListItem>
                <asp:ListItem>Night</asp:ListItem>
            </asp:DropDownList>
            <asp:Label ID="Label5" runat="server" 
                Style="left: 390px; position: absolute; top: 62px; height: 20px; z-index: 1;" 
            ...
            <asp:DropDownList ID="DropDownList2" runat="server" AppendDataBoundItems="True" 
                ...
                style="z-index: 1; left: 83px; top: 34px; position: absolute; right: 428px" 
    ...
    <p>
        ...
        <asp:Button ID="Button11" runat="server" BackColor="Gray" BorderStyle="Solid" 
            ...
            Text="Paste Manpower Data" onclick="Button11_Click" Enabled="False" 
            ForeColor="White"/>
        </p>
